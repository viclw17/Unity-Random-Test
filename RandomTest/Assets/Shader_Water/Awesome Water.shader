...
Shader "Victor/Awesome Water" {
	Properties{
		_SpeedX("Wave Speed X", Range(-0.1, 0.1)) = 0.1
	    _SpeedZ("Wave Speed Z", Range(-0.1, 0.1)) = 0.1
		
		_BumpMap("Normal Map", 2D) = "bump" {}
	    _NormalStrength("Normal Strength", Range(-5, 5)) = 0.5

		_Cube("Reflection Map", Cube) = "" {}
		_Shininess("Shininess", Range(10, 5000)) = 1000

		_DistortTex("Distortion", 2D) = "white" {}
		_Refraction("Refraction", Range(0.00, 100.0)) = 10.0
